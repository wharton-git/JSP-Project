					...
					<div class="hidden sm:ml-6 sm:block">
						<div class="flex space-x-4">
							...
							<a href="#"
								...
								class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Graph</a>
						</div>
					</div>
				</div>
				<div
		...
		<div class="sm:hidden" id="mobile-menu">
			<div class="space-y-1 px-2 pb-3 pt-2">
				...
				<a href="#"
					...
					aria-current="page">Liste</a> <a href="/jspSujet3/list"
					class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Graph</a>
			</div>
		</div>
	</nav>
        ...
        %>
									<tr class="bg-black bg-opacity-20">
										...
										<td class="px-6 py-4 whitespace-nowrap"><a
											class="bg-yellow-200 px-2 py-1 rounded-lg text-black"
											href="/jspSujet3/modify?id=<%= emp[0] %>">Modifier</a></td>
										<td class="px-6 py-4 whitespace-nowrap"><a
											class="bg-red-400 px-2 py-1 rounded-lg text-black"
